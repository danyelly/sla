...
import { ScrollView, FlatList, Image, Text, View, TextInput, TouchableOpacity, StyleSheet, ImageBackground } from 'react-native';
                ...
                renderItem={({ item }) => {
                  return (
                    <View>
                      ...
                      >
                        <Image source={{ uri: URL + item.image + Media }} style={{
                          height: 200,
                          width: 200,
                          justifyContent: 'center',
                          borderRadius: 5,
                      ...
                      >
                        ...
                        >Categoria: {item.idCategoriaFK}</Text>
                        <Text style={{
                          backgroundColor: '#0b090a',
                          borderRadius: 5,
                          padding: 10,
